...
orderRoute.get("/", _util.isAuth, /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            //to have access to user info, not just an id
            res.send(orders);
...
orderRoute.get("/mine", _util.isAuth, /*#__PURE__*/function () {
...
orderRoute.get("/:id", _util.isAuth, /*#__PURE__*/function () {
...
orderRoute["delete"]("/:id", _util.isAuth, _util.isAdmin, /*#__PURE__*/function () {
...
orderRoute.post("/", _util.isAuth, /*#__PURE__*/function () {
