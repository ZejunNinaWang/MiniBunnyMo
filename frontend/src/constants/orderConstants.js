...
export const ORDER_LIST_REQUEST = 'MY_ORDER_LIST_REQUEST';
export const ORDER_LIST_SUCCESS = 'MY_ORDER_LIST_SUCCESS';
export const ORDER_LIST_FAIL = 'MY_ORDER_LIST_FAIL';
